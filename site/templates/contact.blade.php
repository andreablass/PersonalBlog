    ...
    <div class="p-4 text-center font-semibold flex items-center justify-center">
        <div class="w-full max-w-lg">
            <section class="text-black">
                <h2 class="text-3xl font-semibold text-black-700 pt-16 text-center p-10">Contact me</h2>
                <div class="flex items-center justify-around text-center pt-6 space-x-8  text-gray-500">
                    <!-- Address -->
